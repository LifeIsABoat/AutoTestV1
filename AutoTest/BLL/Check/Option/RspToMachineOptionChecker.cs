...
{
    class RspToMachineOptionChecker : AbstractChecker
    {
        //check Example:
        ...
        private bool checkOptionSetting(string ftbButtonWord, object runtimeScreen)
        {
            ...
            if (currentButton != null)
            {
                ...
                else
                {
                    ...
                    {
                        StaticLog4NetLogger.reportLogger.Info("TC-" + currentTcIndex + "Mabybe NowScreen is Ip Adress Screen,you can't change this MachineIP.");
                        checkResult = false;
                    }
                }
            }
