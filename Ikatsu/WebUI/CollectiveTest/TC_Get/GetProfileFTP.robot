...
GetNo.4-6-6
    GoToPageRoot
    GoToPath    ${Path20}
    ${current_text}    GetSubNodeValue    ${Index20}
    Should Be Equal    ${current_text}    ${Value20}
GetNo.4-6-7
    GoToPageRoot
    GoToPath    ${Path6}
...
GetNo.4-6-20
    GoToPageRoot
    GoToPath    ${Path19}
    ${current_text}    GetSubNodeValue    ${Index19}
    Should Be Equal    ${current_text}    ${Value19}
GetNo.4-6-21
    GoToPageRoot
    GoToPath    ${Path3}
